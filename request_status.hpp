...
enum class request_status : u08 {
 ...
 task_id_not_string,
 task_id_not_uuid,
 patient_medication_id_not_found,
 patient_medication_id_not_string,
 patient_medication_id_not_uuid,
};

inline constexpr std::array<std::pair<request_status, std::string_view>, 26> REQUEST_STATUS_LOOKUP {
 ...
 std::pair<request_status, std::string_view>{ request_status::task_id_not_found               , "request_status::task_id_not_found"                },
 std::pair<request_status, std::string_view>{ request_status::task_id_not_string              , "request_status::task_id_not_string"               },
 std::pair<request_status, std::string_view>{ request_status::task_id_not_uuid                , "request_status::task_id_not_uuid"                 },
 std::pair<request_status, std::string_view>{ request_status::patient_medication_id_not_found , "request_status::patient_medication_id_not_found"  },
 std::pair<request_status, std::string_view>{ request_status::patient_medication_id_not_string, "request_status::patient_medication_id_not_string" },
 std::pair<request_status, std::string_view>{ request_status::patient_medication_id_not_uuid  , "request_status::patient_medication_id_not_uuid"   },
};
